...
namespace WADProject.Controllers
{
    ...
    public class CurrencyController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Weight")] Currency currency)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Weight")] Currency currency)
        {
            if (id != currency.Id)
            {
                return NotFound();
